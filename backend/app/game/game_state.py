...
class GameState:
    ...
    def _generate_villagers(self, count: int):
        ...
        favorite_foods = [
            ...
            "烤野豬", "蘑菇湯", "燻火腿", "麥芽酒", "烤鹿肉", "燉羊膝", "醃魚", "乾酪",
            "莓果塔", "烤鵝", "蒜味麵包", "蔬菜燉肉", "肉派", "鮮奶", "烤兔肉", "乾果"
        ]
        ...
        dislikes = [
            ...
            "乾旱", "狼群", "壞天氣", "泥濘", "腐壞食物", "巫婆", "詛咒", "貴族",
            "徵兵", "老鼠", "黑暗", "孤獨", "生病", "欠債", "謠言", "貪婪商人"
        ]
        ...
        for i in range(count):
            ...
            # 隨機選擇喜好（4-8個）
            num_hobbies = random.randint(4, 8)
            villager_hobbies = random.sample(hobbies, num_hobbies)
            
            # 隨機喜歡的食物（4-8個）
            villager_foods = random.sample(favorite_foods, random.randint(4, 8))
            
            # 隨機討厭的事物（4-8個）
            villager_dislikes = random.sample(dislikes, random.randint(4, 8))
